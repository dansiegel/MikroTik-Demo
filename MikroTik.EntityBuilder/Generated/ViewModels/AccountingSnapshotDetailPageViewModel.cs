...
namespace ModemConfigurator.ViewModels
{
    ...
    {
        public AccountingSnapshotDetailPageViewModel(INavigationService navigationService, IPageDialogService pageDialogService, Services.IModemSettings modemSettings) 
