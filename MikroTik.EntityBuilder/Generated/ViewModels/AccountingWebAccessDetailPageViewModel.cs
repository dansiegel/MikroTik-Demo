...
namespace ModemConfigurator.ViewModels
{
    ...
    {
        public AccountingWebAccessDetailPageViewModel(INavigationService navigationService, IPageDialogService pageDialogService, Services.IModemSettings modemSettings) 
