...
namespace ModemConfigurator.ViewModels
{
    ...
    {
        public ConnectionTrackingPageViewModel(INavigationService navigationService, IPageDialogService pageDialogService, Services.IModemSettings modemSettings) 
