...
namespace ModemConfigurator.ViewModels
{
    ...
    {
        public FirewallAddressListDetailPageViewModel(INavigationService navigationService, IPageDialogService pageDialogService, Services.IModemSettings modemSettings) 
