...
namespace ModemConfigurator.ViewModels
{
    ...
    {
        public FirewallAddressListPageViewModel(INavigationService navigationService, IPageDialogService pageDialogService, Services.IModemSettings modemSettings) 
