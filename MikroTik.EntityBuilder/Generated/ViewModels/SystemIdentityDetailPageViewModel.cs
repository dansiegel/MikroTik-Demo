...
namespace ModemConfigurator.ViewModels
{
    ...
    {
        public SystemIdentityDetailPageViewModel(INavigationService navigationService, IPageDialogService pageDialogService, Services.IModemSettings modemSettings) 
