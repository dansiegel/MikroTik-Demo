...
namespace ModemConfigurator.ViewModels
{
    ...
    {
        public SystemResourceDetailPageViewModel(INavigationService navigationService, IPageDialogService pageDialogService, Services.IModemSettings modemSettings) 
