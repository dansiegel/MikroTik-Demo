...
namespace ModemConfigurator.ViewModels
{
    ...
    {
        public WirelessSnifferDetailPageViewModel(INavigationService navigationService, IPageDialogService pageDialogService, Services.IModemSettings modemSettings) 
